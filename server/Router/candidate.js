...
import { getCandidate, updateCandidate, deleteCandidate,getAllCandidates ,mailCandidate ,getCandidatesByJobId,getShortListedByJobId} from '../Controller/candidateController.js';
...
router.get('/shortlisted/:jobId', getShortListedByJobId); // Get all candidates
